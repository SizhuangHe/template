...
```shell
git clone https://github.com/SizhuangHe/template
```
...
5) Build a local version of your site by executing `hugo server`. You can see the site by navigating to `http://localhost:1313/template/` (actual URL will be outputted in the CLI) in a browser.
...
`hugo.yaml`:
```yaml
baseURL: 'https://SizhuangHe.github.io/template'
title: 'Qubt Theme'
```
...
links:
  - github: https://github.com/SizhuangHe/template
  - link: https://github.com/SizhuangHe/template#readme
...
`https://SizhuangHe.github.io/template`